...
compatibility: Requires the Bend 2 CLI. Detailed claims were checked with Bend 2.0.22; trust the installed `bend guide` and `bend base <Name>` when versions differ.
---
